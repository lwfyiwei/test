...
public class GenericReadDao {
	...
	public long generateSequence(String sqlNameWithNameSpace) {
		return readSqlSessionTemplate.<Long> selectOne(sqlNameWithNameSpace);
	}

	
	
	public <T> int insertAndReturnAffectedCount(String sqlNameWithNameSpace, T obj) {
		return readSqlSessionTemplate.insert(sqlNameWithNameSpace, obj);
	}
	...
	public int update(String sqlNameWithNameSpace, Map<String, Object> param) {
		return readSqlSessionTemplate.update(sqlNameWithNameSpace, param);
	}

	
	public int delete(String sqlNameWithNameSpace,Object param) {
		return readSqlSessionTemplate.delete(sqlNameWithNameSpace, param);
	}
	...
	public <T> T queryOne(String sqlNameWithNameSpace, Map<String, Object> map) {
		return readSqlSessionTemplate.<T> selectOne(sqlNameWithNameSpace, map);
	}

	
	public Object queryObject(String sqlNameWithNameSpace, Map<String, Object> map) {
		return readSqlSessionTemplate.selectOne(sqlNameWithNameSpace, map);
	}
	...
	public <T> T queryOneByObject(String sqlNameWithNameSpace, String mapKey, Object mapValue) {
		...
		return readSqlSessionTemplate.selectOne(sqlNameWithNameSpace, paramMap);
	}

	
	public <T> T queryUniqueById(String statement, long id) {
		return readSqlSessionTemplate.selectOne(statement, id);
	}

	
	public <T> T queryUniqueById(String statement, String idStr) {
		return readSqlSessionTemplate.selectOne(statement, idStr);
	}
	...
	public int queryCount(String sqlNameWithNameSpace, Map<String, Object> map) {
		return readSqlSessionTemplate.<Integer> selectOne(sqlNameWithNameSpace, map);
	}
	...
	public <T> List<T> queryList(String sqlNameWithNameSpace, Map<String, Object> map) {
		return readSqlSessionTemplate.selectList(sqlNameWithNameSpace, map);
	}
	
	public <K, V> Map<K, V> selectOneToMap(String sqlNameWithNameSpace, Map<K, V> param) {
		return readSqlSessionTemplate.selectOne(sqlNameWithNameSpace, param);
	}
	...
	public List<BatchResult> flushStatements() {
		return readSqlSessionTemplate.flushStatements();
	}
    ...
    public <T> T queryUnique(String sqlNameWithNameSpace, Object param) {
        return readSqlSessionTemplate.<T> selectOne(sqlNameWithNameSpace, param);
    }
    ...
    public int queryCount(String sqlNameWithNameSpace, Object param) {
        return readSqlSessionTemplate.<Integer> selectOne(sqlNameWithNameSpace, param);
    }
    ...
    public <T> List<T> queryList(String sqlNameWithNameSpace, Object param) {
        return readSqlSessionTemplate.selectList(sqlNameWithNameSpace, param);
    }
